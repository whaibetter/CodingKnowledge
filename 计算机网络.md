...
![sadafasdfasdgsdfgafsdfasdgas5464](http://img.whaifree.top//sadafasdfasdgsdfgafsdfasdgas5464.png)

![OSI 七层模型](http://img.whaifree.top//osi-7-model.png)

![osi七层模型2](http://img.whaifree.top//osi%E4%B8%83%E5%B1%82%E6%A8%A1%E5%9E%8B2.png)
...
>
> ![查看源图像](http://img.whaifree.top/image-resp/tcp-6.1.jpg)
>
...
> - 迭代查询
>
>   <img src="http://img.whaifree.top//DNS-process.png" alt="img" style="zoom:50%;" />
>
> - 递归查询
>
>   <img src="http://img.whaifree.top//DNS-process2.png" alt="img" style="zoom:50%;" />
...
2. **证书颁发机构（CA，Certificate Authority）** CA给每个服务器证书，带有 **电子签名**
   - 解决公钥传输的问题：CA私钥加密，给服务器，服务器给客户端，客户端用CA私钥解密。
...
![HTTP/1.0 和 HTTP/1.1 对比](http://img.whaifree.top//http1.0-vs-http1.1.png)
...
![HTTP/1.0 和 HTTP/1.1 对比](http://img.whaifree.top//http1.1-vs-http2.0.png)
...
![SMTP 协议](http://img.whaifree.top//what-is-smtp.png)
